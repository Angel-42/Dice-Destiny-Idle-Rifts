...
class WeaponsDatabase {
  ...
  static const Equipment healingRod = Equipment(
    ...
    name: 'Healing Rod',
    emoji: '⚕️',
    sprite: 'assets/weapons/rods/healing_rod_save.png',
    type: EquipmentType.weapon,
    rarity: EquipmentRarity.common,
  ...
  static const Equipment sacredStaff = Equipment(
    ...
    name: 'Sacred Staff',
    emoji: '✝️',
    sprite: 'assets/weapons/rods/sacred_staff_save.png',
    type: EquipmentType.weapon,
    rarity: EquipmentRarity.uncommon,
  ...
  static const Equipment divineScepter = Equipment(
    ...
    name: 'Divine Scepter',
    emoji: '🕊️',
    sprite: 'assets/weapons/rods/divine_scepter_save.png',
    type: EquipmentType.weapon,
    rarity: EquipmentRarity.rare,
  ...
  static const Equipment holyGrail = Equipment(
    ...
    name: 'Holy Grail',
    emoji: '🏆',
    sprite: 'assets/weapons/rods/holy_grail_save.png',
    type: EquipmentType.weapon,
    rarity: EquipmentRarity.legendary,
